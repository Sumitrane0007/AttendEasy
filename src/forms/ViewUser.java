...
public class ViewUser extends javax.swing.JFrame {
    ...
    public ViewUser() {
        initComponents();
        AEUtility.setImage(this,"images/abc1.jpg",1160, 577);
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(1160, 577));
        setMinimumSize(new java.awt.Dimension(1160, 577));
        setUndecorated(true);
    ...
    private void userTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userTableMouseClicked
        ...
        if(!Objects.isNull (name)){
            String imagePath = AEUtility.getPath("/images" + File.separator + name);
