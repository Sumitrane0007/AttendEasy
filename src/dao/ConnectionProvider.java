...
public class ConnectionProvider {
    ...
    private static final String DB_NAME = "attendanceJframeae";
    private static final String DB_URL = "jdbc:mysql://localhost:3306/";
    private static final String DB_USERNAME = "root";
    private static final String DB_PASSWORD = "9421";
    ...
    public static Connection getCon(){
        try{
           ...
           con = DriverManager.getConnection(DB_URL+DB_NAME+"?SSL=false",DB_USERNAME,DB_PASSWORD);
           return con;
        }catch(Exception e){
            e.printStackTrace();
            return null;
